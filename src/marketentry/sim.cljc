...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (ARM, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up ineligible-bidders-list membership) ==")
    ...
    (println "== filing/submit eng-4 (ineligible-bidders-list membership -> HARD hold) ==")
